                ...
                renderItem={(item) => (
                    ...
                    <List.Item key={item.id}>
                        <List.Item.Meta
                            ...
                            title={<a onClick={() => showMessages(service, item.id, item.user_name, item.email)}>{item.org_name}</a>}
                ...
                <Row gutter={[12, 12]} justify="center">
                    {
                        load ?
                            ...
                            :
                            <Col xs={24}>
                                <Chat data={data} conversation={messages}
                                    callApi={callApi}
                                    user={user} reloadChat={reloadChat} setReloadChat={setReloadChat} goBottom={goBottom}
                                    op={op}
                                    />
                            </Col>
                    }
